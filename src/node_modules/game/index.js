...
import {Point, Rectangle, SCALE_MODES, settings, Sprite} from 'pixi.js';
...
class TestScene extends Scene {
  init() {
    ...
    const face = this.face = Sprite.fromFrame('happy');
    face.position.set(300);
    face.scale.set(3);
  ...
  update(delta) {
    ...
    const collision = Rectangle.getCollision(this.sprite.getBounds(), this.face.getBounds(), 0);
    Rectangle.resolveCollision(this.sprite.position, this.face.position, collision);
  }
